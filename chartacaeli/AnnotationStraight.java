...
public class AnnotationStraight extends chartacaeli.model.AnnotationStraight implements PostscriptEmitter {
	...
	public void emitPS( ApplicationPostscriptStream ps ) {
		...
		for ( ns=0, n0=0, height=0 ; ns<getScriptCount() ; ns++ ) {
			script = new chartacaeli.model.Script() ;
	...
	public static void emitPS( ApplicationPostscriptStream ps, chartacaeli.model.TextType text, double height, double shift,
