...
public class HorizonLocal extends HorizonType {
	...
	private chartacaeli.model.HorizonLocal peer ;

	public HorizonLocal( chartacaeli.model.HorizonLocal peer, Projector projector ) {
		super( projector ) ;
	...
	private Coordinate inverse( Coordinate equatorial ) {
		...
		return new chartacaeli.Coordinate(
