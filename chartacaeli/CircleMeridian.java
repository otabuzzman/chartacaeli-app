...
public class CircleMeridian extends chartacaeli.model.CircleMeridian implements PostscriptEmitter, Baseline, Converter {
	...
	public double transformMeridianAl( double vlaz ) {
		...
		gnho = new chartacaeli.Coordinate( CAACoordinateTransformation.Equatorial2Horizontal(
