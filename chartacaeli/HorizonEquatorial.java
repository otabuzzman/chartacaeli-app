...
public class HorizonEquatorial extends HorizonType {
	...
	private chartacaeli.model.HorizonEquatorial peer ;
	private Projector projector ;

	public HorizonEquatorial( chartacaeli.model.HorizonEquatorial peer, Projector projector ) {
		super( projector ) ;
	...
	public void emitPS( ApplicationPostscriptStream ps ) {
		chartacaeli.model.Catalog catalog ;
	...
	private PostscriptEmitter catalog( chartacaeli.model.CatalogADC1239H peer ) {
	...
	private PostscriptEmitter catalog( chartacaeli.model.CatalogADC1239T peer ) {
	...
	private PostscriptEmitter catalog( chartacaeli.model.CatalogADC5050 peer ) {
	...
	private PostscriptEmitter catalog( chartacaeli.model.CatalogADC5109 peer ) {
	...
	private PostscriptEmitter catalog( chartacaeli.model.CatalogADC6049 peer ) {
	...
	private PostscriptEmitter catalog( chartacaeli.model.CatalogADC7118 peer ) {
	...
	private PostscriptEmitter catalog( chartacaeli.model.CatalogADC7237 peer ) {
	...
	private PostscriptEmitter catalog( chartacaeli.model.CatalogDS9 peer ) {
		CatalogDS9 catalog ;
