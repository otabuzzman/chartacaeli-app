...
public class Artwork extends org.chartacaeli.model.Artwork implements PostscriptEmitter {
	...
	private final static String DEFAULT_PJ2WORKER	= "org.chartacaeli.Artwork$PJ2TextureMapperSeq" ;
	...
	private class PJ2TextureMapperJni extends Task {
		...
		org.chartacaeli.gpu.tst.Coordinate eq ;
		...
		public PJ2TextureMapperJni() {
			...
			lamphi = new double[3] ;
			eq = new org.chartacaeli.gpu.tst.Coordinate() ;
		...
		public void main( String[] argv ) throws Exception {
			org.chartacaeli.gpu.tst.RealMatrix tmM2Pc3p ;
			double[] tmM2Pj[], tmM2Pc = new double[9] ;
			org.chartacaeli.gpu.tst.RealMatrix tmH2Tc3p ;
			double[] tmH2Tj[], tmH2Tc = new double[16] ;
			org.chartacaeli.gpu.tst.Plane spTc3p ;
			P4Projector projj ;
			org.chartacaeli.gpu.tst.P4Projector projc ;
			Class<?> projcls ;
			Constructor<?> projctr ;
			...
			tmM2Pc3p = new org.chartacaeli.gpu.tst.RealMatrix( tmM2Pc, 3, 3 ) ;

			projj = (P4Projector) Registry.retrieve( P4Projector.class.getName() ) ;
			projcls = Class.forName( "org.chartacaeli.gpu.tst."+projj.getClass().getSimpleName() ) ;
			projctr = projcls.getConstructor() ;
			projc = (org.chartacaeli.gpu.tst.P4Projector) projctr.newInstance() ;
			projc.init( projj.lam0(), projj.phi1(), projj.R(), projj.k0() ) ;

			spTc3p = new org.chartacaeli.gpu.tst.Plane(
			...
			tmH2Tc3p = new org.chartacaeli.gpu.tst.RealMatrix( tmH2Tc, 4, 4 ) ;
	...
	private class PJ2TextureMapperC3p extends Task {
		...
		public void main( String[] argv ) throws Exception {
			...
			double[] spTc ;
			P4Projector proj ;
			org.chartacaeli.gpu.tst.PJ2TextureMapperC3p texMapC3p ;
			...
			texMapC3p = new org.chartacaeli.gpu.tst.PJ2TextureMapperC3p( proj.getClass().getSimpleName(),
	...
	public void load() {
		org.chartacaeli.Coordinate c ;

		// poppers of heaven
		c = new org.chartacaeli.Coordinate( valueOf( getPopper( 0 ).getPosition() ) ) ;
		popHP1 = c.cartesian() ;
	...
	private Coordinate[] projT() {
		...
		v0 = new Vector( projector.project( new org.chartacaeli.Coordinate( c[0], c[1], c[2] ).spherical(), false ) ) ;
		c = tmT2H.operate( new double[] { maxo/2, 0, 0, 1 } ) ;
		v1 = new Vector( projector.project( new org.chartacaeli.Coordinate( c[0], c[1], c[2] ).spherical(), false ) ) ;
		c = tmT2H.operate( new double[] { maxo, 0, 0, 1 } ) ;
		v2 = new Vector( projector.project( new org.chartacaeli.Coordinate( c[0], c[1], c[2] ).spherical(), false ) ) ;
		...
		for ( int o=stepping ; maxo-1>o ; o+=stepping ) {
			...
			outline.add( projector.project( new org.chartacaeli.Coordinate( c[0], c[1], c[2] ).spherical(), false ) ) ;
		}
