...
public class CatalogADC5109Record extends org.chartacaeli.model.CatalogADC5109Record implements CatalogRecord {
	...
	public void register() {
		...
		sub = cat.substitute( QK_E_POS, QK_E_POS ) ;
		Registry.register( sub, e_pos ) ;
		sub = cat.substitute( QK_F_POS, QK_F_POS ) ;
		Registry.register( sub, f_pos ) ;
		sub = cat.substitute( QK_R_POS, QK_R_POS ) ;
		...
		sub = cat.substitute( QK_R_PM, QK_R_PM ) ;
		Registry.register( sub, r_pm ) ;
		sub = cat.substitute( QK_RV, QK_RV ) ;
		Registry.register( sub, RV ) ;
		sub = cat.substitute( QK_R_RV, QK_R_RV ) ;
		...
		sub = cat.substitute( QK_R_PLX, QK_R_PLX ) ;
		Registry.register( sub, r_Plx ) ;
		sub = cat.substitute( QK_GCI_X, QK_GCI_X ) ;
		Registry.register( sub, GCI_X ) ;
		sub = cat.substitute( QK_GCI_Y, QK_GCI_Y ) ;
		Registry.register( sub, GCI_Y ) ;
		sub = cat.substitute( QK_GCI_Z, QK_GCI_Z ) ;
		...
		sub = cat.substitute( QK_VDER, QK_VDER ) ;
		Registry.register( sub, Vder ) ;
		sub = cat.substitute( QK_E_VMAG, QK_E_VMAG ) ;
		Registry.register( sub, e_Vmag ) ;
		sub = cat.substitute( QK_F_VMAG, QK_F_VMAG ) ;
		...
		sub = cat.substitute( QK_BMAG, QK_BMAG ) ;
		Registry.register( sub, Bmag ) ;
		sub = cat.substitute( QK_BV, QK_BV ) ;
		Registry.register( sub, BV ) ;
		sub = cat.substitute( QK_E_BMAG, QK_E_BMAG ) ;
		Registry.register( sub, e_Bmag ) ;
		sub = cat.substitute( QK_F_BMAG, QK_F_BMAG ) ;
		Registry.register( sub, f_Bmag ) ;
		sub = cat.substitute( QK_R_BMAG, QK_R_BMAG ) ;
		Registry.register( sub, r_Bmag ) ;
		sub = cat.substitute( QK_UMAG, QK_UMAG ) ;
		Registry.register( sub, Umag ) ;
		sub = cat.substitute( QK_UB, QK_UB ) ;
		Registry.register( sub, UB ) ;
		sub = cat.substitute( QK_E_UMAG, QK_E_UMAG ) ;
		Registry.register( sub, e_Umag ) ;
		sub = cat.substitute( QK_N_UMAG, QK_N_UMAG ) ;
		Registry.register( sub, n_Umag ) ;
		sub = cat.substitute( QK_R_UMAG, QK_R_UMAG ) ;
		Registry.register( sub, r_Umag ) ;
		sub = cat.substitute( QK_PTV, QK_PTV ) ;
		Registry.register( sub, Ptv ) ;
		sub = cat.substitute( QK_R_PTV, QK_R_PTV ) ;
		Registry.register( sub, r_Ptv ) ;
		sub = cat.substitute( QK_PTG, QK_PTG ) ;
		Registry.register( sub, Ptg ) ;
		sub = cat.substitute( QK_R_PTG, QK_R_PTG ) ;
		Registry.register( sub, r_Ptg ) ;
		sub = cat.substitute( QK_SPMK, QK_SPMK ) ;
		Registry.register( sub, SpMK ) ;
		sub = cat.substitute( QK_R_SPMK, QK_R_SPMK ) ;
		Registry.register( sub, r_SpMK ) ;
		sub = cat.substitute( QK_SP, QK_SP ) ;
		Registry.register( sub, Sp ) ;
		sub = cat.substitute( QK_R_SP, QK_R_SP ) ;
		...
		sub = cat.substitute( QK_ORBPER, QK_ORBPER ) ;
		Registry.register( sub, orbPer ) ;
		sub = cat.substitute( QK_PA, QK_PA ) ;
		Registry.register( sub, PA ) ;
		sub = cat.substitute( QK_DATE, QK_DATE ) ;
		Registry.register( sub, date ) ;
		sub = cat.substitute( QK_R_DUP, QK_R_DUP ) ;
		Registry.register( sub, r_Dup ) ;
		sub = cat.substitute( QK_N_DMAG, QK_N_DMAG ) ;
		Registry.register( sub, n_Dmag ) ;
		sub = cat.substitute( QK_DIST1, QK_DIST1 ) ;
		Registry.register( sub, dist1 ) ;
		sub = cat.substitute( QK_DIST2, QK_DIST2 ) ;
		Registry.register( sub, dist2 ) ;
		sub = cat.substitute( QK_ID_A, QK_ID_A ) ;
		Registry.register( sub, ID_A ) ;
		sub = cat.substitute( QK_ID_B, QK_ID_B ) ;
		Registry.register( sub, ID_B ) ;
		sub = cat.substitute( QK_ID_C, QK_ID_C ) ;
		Registry.register( sub, ID_C ) ;
		sub = cat.substitute( QK_MAGMAX, QK_MAGMAX ) ;
		Registry.register( sub, magMax ) ;
		sub = cat.substitute( QK_MAGMIN, QK_MAGMIN ) ;
		Registry.register( sub, magMin ) ;
		sub = cat.substitute( QK_VARAMP, QK_VARAMP ) ;
		Registry.register( sub, varAmp ) ;
		sub = cat.substitute( QK_N_VARAMP, QK_N_VARAMP ) ;
		Registry.register( sub, n_varAmp ) ;
		sub = cat.substitute( QK_VARPER, QK_VARPER ) ;
		Registry.register( sub, varPer ) ;
		sub = cat.substitute( QK_VAREP, QK_VAREP ) ;
		Registry.register( sub, varEp ) ;
		sub = cat.substitute( QK_VARTYP, QK_VARTYP ) ;
		Registry.register( sub, varTyp ) ;
		sub = cat.substitute( QK_R_VAR, QK_R_VAR ) ;
		Registry.register( sub, r_var ) ;
		sub = cat.substitute( QK_MAG1, QK_MAG1 ) ;
		Registry.register( sub, mag1 ) ;
		sub = cat.substitute( QK_VMAG1, QK_VMAG1 ) ;
		Registry.register( sub, vmag1 ) ;
		sub = cat.substitute( QK_E_MAG1, QK_E_MAG1 ) ;
		Registry.register( sub, e_mag1 ) ;
		sub = cat.substitute( QK_N_MAG1, QK_N_MAG1 ) ;
		Registry.register( sub, n_mag1 ) ;
		sub = cat.substitute( QK_P_MAG1, QK_P_MAG1 ) ;
		Registry.register( sub, p_mag1 ) ;
		sub = cat.substitute( QK_R_MAG1, QK_R_MAG1 ) ;
		Registry.register( sub, r_mag1 ) ;
		sub = cat.substitute( QK_MAG2, QK_MAG2 ) ;
		Registry.register( sub, mag2 ) ;
		sub = cat.substitute( QK_VMAG2, QK_VMAG2 ) ;
		Registry.register( sub, vmag2 ) ;
		sub = cat.substitute( QK_E_MAG2, QK_E_MAG2 ) ;
		Registry.register( sub, e_mag2 ) ;
		sub = cat.substitute( QK_N_MAG2, QK_N_MAG2 ) ;
		Registry.register( sub, n_mag2 ) ;
		sub = cat.substitute( QK_P_MAG2, QK_P_MAG2 ) ;
		Registry.register( sub, p_mag2 ) ;
		sub = cat.substitute( QK_R_MAG2, QK_R_MAG2 ) ;
		Registry.register( sub, r_mag2 ) ;
		sub = cat.substitute( QK_CI1, QK_CI1 ) ;
		Registry.register( sub, ci1 ) ;
		sub = cat.substitute( QK_F_MAG1, QK_F_MAG1 ) ;
		Registry.register( sub, f_mag1 ) ;
		sub = cat.substitute( QK_F_MAG2, QK_F_MAG2 ) ;
		Registry.register( sub, f_mag2 ) ;
		sub = cat.substitute( QK_MAG3, QK_MAG3 ) ;
		Registry.register( sub, mag3 ) ;
		sub = cat.substitute( QK_VMAG3, QK_VMAG3 ) ;
		Registry.register( sub, vmag3 ) ;
		sub = cat.substitute( QK_E_MAG3, QK_E_MAG3 ) ;
		Registry.register( sub, e_mag3 ) ;
		sub = cat.substitute( QK_N_MAG3, QK_N_MAG3 ) ;
		Registry.register( sub, n_mag3 ) ;
		sub = cat.substitute( QK_P_MAG3, QK_P_MAG3 ) ;
		Registry.register( sub, p_mag3 ) ;
		sub = cat.substitute( QK_R_MAG3, QK_R_MAG3 ) ;
		Registry.register( sub, r_mag3 ) ;
		sub = cat.substitute( QK_F_MAG3, QK_F_MAG3 ) ;
