...
%CUDA_HOME%\bin\nvcc -DP4Mollweide_f_MAIN -Wno-deprecated-gpu-targets -I%CUDA_HOME%\..\CUDASamples\common\inc -o dcp\P4Mollweide_f.o -dc dcp\P4Mollweide_f.cu
rem compile executable file
%CUDA_HOME%\bin\nvcc -Wno-deprecated-gpu-targets -o dcp\P4Mollweide_f.exe dcp\P4Mollweide_f.o dcp\Math_f.o dcp\Coordinate_f.o
rem cleanup
del dcp\P4Mollweide_f.lib dcp\P4Mollweide_f.exp
