...
public class CircleMeridian extends org.chartacaeli.model.CircleMeridian implements PostscriptEmitter, Baseline, Converter {
	...
	public void register() {
		org.chartacaeli.Coordinate alphaXY, omegaXY ;
		double az ;
		DMS dms ;

		alphaXY = new org.chartacaeli.Coordinate( posVecOfScaleMarkVal( alpha() ) ) ;
		alphaXY.register( this, QK_ALPHAXY ) ;
		omegaXY = new org.chartacaeli.Coordinate( posVecOfScaleMarkVal( omega() ) ) ;
	...
	public void degister() {
		org.chartacaeli.Coordinate.degister( this, QK_ALPHAXY ) ;
		org.chartacaeli.Coordinate.degister( this, QK_OMEGAXY ) ;
	...
	public double transformMeridianAl( double vlaz ) {
		...
		gnho = new org.chartacaeli.Coordinate( CAACoordinateTransformation.Equatorial2Horizontal(
