...
import org.chartacaeli.UnicodePostscriptStream.UnicodeControlBlock;

@SuppressWarnings("serial")
public class AnnotationStraight extends org.chartacaeli.model.AnnotationStraight implements PostscriptEmitter {
	...
	public void emitPS( ApplicationPostscriptStream ps ) {
		...
		double margin, rise ;
		org.chartacaeli.model.Script script ;
		ChartPage page ;
		int num, ns, n0 ;
		double p, height ;
		String[] xyRaw ;
		...
		for ( ns=0, n0=0, height=0 ; ns<getScriptCount() ; ns++ ) {
			script = new org.chartacaeli.model.Script() ;
	...
	public static void emitPS( ApplicationPostscriptStream ps, org.chartacaeli.model.TextType text, double height, double shift,
