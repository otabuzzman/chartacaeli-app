...
public class DialDeg extends org.chartacaeli.model.DialDeg implements PostscriptEmitter {
	...
	private class ScalebaseNone extends org.chartacaeli.model.ScalebaseNone implements PostscriptEmitter {
	...
	private class ScalebaseLine extends org.chartacaeli.model.ScalebaseLine implements PostscriptEmitter {
		...
		public void emitPS( ApplicationPostscriptStream ps ) {
			...
			nrm = org.chartacaeli.Coordinate.cloneAll( bot ) ;
			org.chartacaeli.Coordinate.parallelShift( nrm, getReflect()?-1:1 ) ;
			...
			org.chartacaeli.Coordinate.parallelShift( bot, getReflect()?-space:space ) ;
	...
	private class ScalebaseRail extends org.chartacaeli.model.ScalebaseRail implements PostscriptEmitter {
		...
		public void emitPS( ApplicationPostscriptStream ps ) {
			...
			for ( int i=0 ; n>i ; i++ ) {
				...
				top = org.chartacaeli.Coordinate.cloneAll( bot ) ;
	...
	public void emitPS( ApplicationPostscriptStream ps ) {
		...
		Coordinate eq ;
		boolean baseattr ;
		org.chartacaeli.model.ScalebaseType peer ;
		...
		org.chartacaeli.Coordinate.parallelShift( t01, getReflect()?-t00:t00 ) ;
		ps.array( true ) ;
